## code to prepare `SPEC_FOR_WISEDASH_PS_ENROLLMENT` dataset goes here

SPEC_FOR_WISEDASH_PS_ENROLLMENT <- list(
...
usethis::use_data(SPEC_FOR_WISEDASH_PS_ENROLLMENT, overwrite = TRUE)
